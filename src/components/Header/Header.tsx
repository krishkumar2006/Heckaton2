  ...
  return (
    <div>
      ...
      <div className="flex w-full h-[100px] bg-[#FBEBB5] justify-end items-center border-black border-2">
        <ul className="flex space-x-4 md:space-x-16 text-sm md:text-base">
          <li>Home</li>
          <li>Shop</li>
          <li>About</li>
          <li>Contact</li>
        ...
        <div className="flex space-x-4 md:space-x-8 mx-8">
          <Image src={acc} alt="Account" className="w-[20px] h-[20px] md:w-[30px] md:h-[30px]" />
          <Image src={heart} alt="Likes" className="w-[20px] h-[20px] md:w-[30px] md:h-[30px]" />
          <Image src={search} alt="Search" className="w-[20px] h-[20px] md:w-[30px] md:h-[30px]" />
          <Image src={cart} alt="Cart" className="w-[20px] h-[20px] md:w-[30px] md:h-[30px]" />
        </div>
      </div>
